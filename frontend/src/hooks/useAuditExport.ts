...
import { appendAuditFilters, type AuditFilters } from '@/hooks/useAudit';
...
export function useAuditExport() {
  return useMutation<
    ...
    Error,
    { cursor?: string | null; limit?: number; filters: AuditFilters }
  >({
    mutationFn: async ({ cursor, limit = 5000, filters }) => {
